#!/bin/bash
NODENAME="0x0cd269016873f3d1F1Dd1B69819982f2dD83e4b8"
BINVER="v1.0.1"
...
# update executables
cd $HOME
wget -qO bifrost-node "https://github.com/bifrost-platform/bifrost-node/releases/download/$BINVER/bifrost-node"
